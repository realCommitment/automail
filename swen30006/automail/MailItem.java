...
public class MailItem {
    ...
    // <edit> stores if wrapped or not
    protected enum WrappingState { UNWRAPPED, HALF_WRAPPED, WRAPPED }
    protected WrappingState wrappingState;
    ...
    public MailItem(int dest_floor, int arrival_time, int weight, boolean isFragile){
        ...
        this.wrappingState = WrappingState.UNWRAPPED;
    }
   ...
   public boolean isWrapped() {
	   return (wrappingState == WrappingState.WRAPPED);
   }
   
   // returns if half wrapped
   public boolean isHalfWrapped() {
	   return (wrappingState == WrappingState.HALF_WRAPPED);
   }
   
   // returns if unwrapped
   public boolean isUnwrapped() {
	   return (wrappingState == WrappingState.UNWRAPPED);
   }
   
   // half wraps
   public void halfWrap() {
	   wrappingState = WrappingState.HALF_WRAPPED;
   }
   
   // full wraps
   public void fullyWrap() {
	   wrappingState = WrappingState.WRAPPED;
   }
   
   // unwraps
   public void unwrap() {
	   wrappingState = WrappingState.UNWRAPPED;
   }
